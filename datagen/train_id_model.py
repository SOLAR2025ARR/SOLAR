...
if __name__ == '__main__':
    ...
    print(f"{usernum} users, {itemnum} items")
    ...
    model = SASRec(usernum, itemnum, args.maxlen, args.hidden_units, args.dropout_rate, args.num_blocks, args.num_heads, args.device).to(args.device) # no ReLU activation in original SASRec implementation?
    ...
    if args.finetune:
        ...
        for param in model.ffn_layers[-1].parameters():
            param.requires_grad = True
        for param in model.attention_layers[-1].parameters():
            param.requires_grad = True
